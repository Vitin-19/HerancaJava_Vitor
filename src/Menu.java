...
public class Menu {
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    break;
                case 2:
                    visualizarFuncionario(funcionarios);
                    break;
                case 3:
                    executarFuncaoDeFuncionario(funcionarios);
                    break;
                case 4:
    ...
    public ArrayList<Funcionario> cadastrarFuncionario(ArrayList<Funcionario> funcionarios) {
        try {
            ...
            System.out.println("Digite o cargo do funcionário: Ex: Gerente,desenvolvedor,estagiario,outro");
            String cargo = scan.nextLine().toLowerCase();
            switch (cargo) {
                case "gerente":
                    if(!verificaDados(cpf, dataNascimento, nome, salario, departamento, cargo)){
                ...
                case "desenvolvedor":
                    ...
                    if(!verificaDados(cpf, dataNascimento, nome, salario, departamento, cargo, linguagens)){
                        System.out.println("Operação cancelada");
                        break;
                    }
                    ...
                    break;
                default:
                    Funcionario novoFuncionario = new Funcionario(cpf, dataNascimento, nome, salario, departamento, cargo);
